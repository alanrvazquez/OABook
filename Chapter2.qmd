...
5. Case study one that needs an orthogonal array.

6. Case study two that needs an orthogonal array.

7. Case study three that needs an orthogonal array?

8. Another type of collapsing: Strong OAs

9. Applications on OAs.
