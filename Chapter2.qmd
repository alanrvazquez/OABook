...
4.  Construct the following OAs by hand.

-   OA($16, 4 \times 2^3, 2$).
-   OA($16, 4 \times 2^3, 3$).

5. Show that an $OA(18, 3^2 2^2,; 2)$ does not exist.

6.  Case study one that needs an orthogonal array.

7.  Case study two that needs an orthogonal array.

8.  Case study three that needs an orthogonal array?

9.  Another type of collapsing: Strong OAs

10.  Applications on OAs.

12. Foldover of a three-level design. Show that you start from strength two and you arrive at a strength three array.

13. Split a two-level fractional factorial design. Split according to a basic column and to a generated column and see if you get an OA of strength 2. 

14. Excercise on collapsing in Section 2.3. 
